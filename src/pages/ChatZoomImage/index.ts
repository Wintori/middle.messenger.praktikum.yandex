...
import template from './chatZoomImage.hbs'
import upload from '../../assets/upload.svg';
import send from '../../assets/arrow-send.svg'
import close from '../../assets/close-image.svg'
import { MessageInput } from '../../components/MessageInput';




interface ChatZoomImagePageProps {
    chatMessagesGroups: ChatMessagesGroupInterface[];
    zoomedImage?: string;
}

export class ChatZoomImagePage extends Block {
    constructor(props: ChatZoomImagePageProps) {
        super(props);
    }
    ...
    init() {
        ...
        this.children.buttonClose = new Button({
            ...
            buttonStyle: 'button__close',
            image: close,
            imageStyle: 'modal-zoom-image__close-image',
            type: 'button'
        })
    }
